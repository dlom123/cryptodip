      ...
      chartDatasets: [
        {
          ...
          data: [
            ...
            390.86, 385.48, 378.20, 393.06, 384.54,
            390.37, 408.25, 414.59, 446.66, 438.65,
            442.16, 461.39, 444.15, 427.28, 419.03,
            418.96, 420.27
          ],
        ...
        },
        {
          ...
          data: [
            ...
            362.12, 361.38, 357.96, 366.26, 359.47,
            364.65, 377.54, 381.42, 408.28, 404.90,
            402.95, 422.24, 410.05, 398.46, 389.14,
            388.49, 390.48
          ],
          backgroundColor: ['red'],
          borderColor: ['orange']
    ...
    this.chartTop100 = new Chart(this.ctx, {
      ...
      data: {
        labels: [
          ...
          '12/15/21', '12/16/21', '12/17/21', '12/18/21', '12/19/21',
          '12/20/21', '12/21/21', '12/22/21', '12/23/21', '12/24/21',
          '12/25/21', '12/26/21', '12/27/21', '12/28/21', '12/29/21',
          '12/30/21', '12/31/21'
        ],
