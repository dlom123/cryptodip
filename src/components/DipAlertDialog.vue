    ...
    <v-card>
      <v-card-title class="pa-2 primary">
        <v-row no-gutters>
          ...
          <v-col cols="2" align="end" align-self="center" class="pr-1">
            <v-btn text plain x-small @click="closeDialog">
        ...
        <v-container>
          ...
          <v-row>
            <v-col class="ml-4 pt-0">
              <v-row no-gutters>
                <v-col cols="4" class="text-overline font-weight-bold"
                  >Cost Average</v-col
                >
                <v-col cols="4" class="text-overline font-weight-bold"
                  >Current Price</v-col
          ...
          <v-row>
            <v-col class="text-h6"> Alert me when... </v-col>
          </v-row>
          <v-row no-gutters class="pt-2">
            <v-col> Current Price is below </v-col>
            <v-col cols="1" align="center">..<em>or</em>..</v-col>
            <v-col class="pl-6"> Buy The Dip? is above </v-col>
          </v-row>
          <v-row>
            <v-col class="pt-0">
              <v-text-field
      ...
      <v-card-actions>
        <v-container>
          <v-row justify="end">
            <v-col cols="3">
              <v-btn block color="" class="mb-2" @click="closeDialog">
                Cancel
              </v-btn>
            </v-col>
            <v-col cols="3">
              <v-btn block color="primary" class="mb-2" @click="onClickSave">
                Save
              </v-btn>
            </v-col>
          </v-row>
...
export default {
    ...
    methods: {
        ...
        resetInputs() {
            ...
            this.alertNotes = this.coin.alerts.notes
        }
    },
    watch: {
        reRender() {
